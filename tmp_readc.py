...
deploy = datetime(2019, t_month, t_date, 11, 0) # assume local time
...
pgl = int(input("Currently stopped at page : "))
pg_total = int(input("Total pages : "))
#pgl = int(input("How many pages left : "))
pg2 = int(pg_total)-int(pgl)
print "Pages left : ", pg2
...
print "Average pages to be processed per minute is :",float(pg2)/float(minl)
